...
<div id="myPageTop" class="page_aticle mypage_top">
	...
	<div class="mypagetop_user">
		<div class="inner_mypagetop">
			<div class="grade_user">
				...
				<div class="grade_bnenfit">
					<div class="benefit">
						<strong class="tit"> </strong> 적립 0.5%
					</div>
		...
		<a href="https://www.kurly.com/shop/main/html.php?htmid=event/kurly.htm&amp;name=friend" class="bnr_event"
